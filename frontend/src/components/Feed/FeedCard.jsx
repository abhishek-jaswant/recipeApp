...
import { getFeed,deleteRecipe } from "../../redux/recipeReducer/actions";
...
// deleteHandler   recipe delete karne ke liye, ye function confirm karega ki user sach mein delete karna chahta hai ya nahi, aur agar haan, toh ye dispatch karega deleteRecipe action ko, jisme recipe ka id, user ka token, toast function for notifications, aur loggedInUser ka id pass hoga.
const deleteHandler = (id) => {
  if (window.confirm("Are you sure?")) {
    // loggedInUser._id yahan se pass karo
    dispatch(deleteRecipe(id, token, toast, loggedInUser._id));
  }
};
...
{recipe.userId._id === loggedInUser._id && (
  <Flex gap={2} flex="0.5">
    <Button
      ...
      colorScheme="blue"
      variant="outline"
      onClick={onOpen} // Isse modal khulega
    >
      Edit
    </Button>
...
<Modal isOpen={isOpen} onClose={onClose} size="xl">
  ...
  <ModalContent maxW="50rem">
    <ModalHeader color="primary.500">EDIT YOUR RECIPE</ModalHeader>
    <ModalCloseButton />
    <ModalBody pb={6}>
      {/* Yahan hum editData bhej rahe hain jo humne Form mein handle kiya hai */}
      <AddRecipeForm closeModal={onClose} editData={recipe} />
    </ModalBody>
  </ModalContent>
</Modal>
          </CardFooter>
