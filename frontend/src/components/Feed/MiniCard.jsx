...
const sendMessage = () => {
  ...
  axios.post(`${process.env.REACT_APP_API_URL}/chat/addmessage`, data);
 ...
 useEffect(() => {
  axios
    ...
    .then((res) => {
      ...
      setChat(res.data); // ✅ IMPORTANT FIX
    })
    .catch((err) => {
      console.log(err);
    });
 ...
 return () => {
  ...
  return (
    <div>
      <Card maxW="md" p="1rem" borderRadius="4px" boxShadow="none" border="1px solid #ddd">
